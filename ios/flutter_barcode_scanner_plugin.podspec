...
# Run `pod lib lint flutter_barcode_scanner_plugin.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_barcode_scanner_plugin'
  s.version          = '0.0.1'
...
A new Flutter plugin supports barcode scanning on both Android and iOS.
  ...
  # s.resource_bundles = {'flutter_barcode_scanner_plugin_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
